...
HyprSpace project doesn't accept Issues directly - we ask you to create a [Discussion](https://github.com/BarutSRB/HyprSpace/discussions) first.
...
As an alternative, you can start a Discussion on [GitHub discussions](https://github.com/BarutSRB/HyprSpace/discussions) forum.
...
Submit bugs to https://github.com/BarutSRB/HyprSpace/discussions/categories/potential-bugs
Submit feature ideas to https://github.com/BarutSRB/HyprSpace/discussions/categories/feature-ideas
...
* Most voted issues: https://github.com/BarutSRB/HyprSpace/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-%2B1-desc
* Sometimes conversations happen on old issues that aren't yet closed. See https://github.com/BarutSRB/HyprSpace/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc
* Issues that are unclear on how to fix, or issues that require design of the interface (CLI or config interface) are tagged with `design-needed` tag https://github.com/BarutSRB/HyprSpace/issues?q=is%3Aissue+is%3Aopen+label%3Adesign-needed
...
Submit your tips to [the Goodies page](https://BarutSRB.github.io/HyprSpace/goodies). The source code of the page can be found in `./docs` directory

## Support the project financially

Supporting the project financially counts as a contribution (even if it's just a $1/month). https://github.com/sponsors/BarutSRB
