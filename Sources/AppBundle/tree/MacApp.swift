...
final class MacApp: AbstractApp {
    ...
    // todo think if it's possible to integrate this global mutable state to https://github.com/BarutSRB/HyprSpace/issues/1215
...
extension [UInt32: AxWindow] {
    ...
    fileprivate mutating func getOrRegisterAxWindow(windowId id: UInt32, _ axWindow: AXUIElement, _ nsApp: NSRunningApplication, _ job: RunLoopJob) throws -> AxWindow? {
        ...
        // https://github.com/BarutSRB/HyprSpace/issues/1001
...
private func setFrame(_ window: AXUIElement, _ topLeft: CGPoint?, _ size: CGSize?) {
    // Set size and then the position. The order is important https://github.com/BarutSRB/HyprSpace/issues/143
    //                                                        https://github.com/BarutSRB/HyprSpace/issues/335
