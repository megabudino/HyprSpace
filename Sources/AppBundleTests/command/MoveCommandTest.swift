    ...
    var layoutDescription: LayoutDescription {
        return switch nodeCases {
            ...
            case .tilingContainer(let container):
                // Dwindle is the only layout now, use orientation for test representation
...
enum LayoutDescription: Equatable {
    ...
    case h_tiles([LayoutDescription])  // Represents horizontal dwindle containers in tests
    case v_tiles([LayoutDescription])  // Represents vertical dwindle containers in tests
    case window(UInt32)
