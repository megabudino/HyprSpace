...
extension AxUiElementMock {
    ...
    func isDialogHeuristic(appBundleId id: String?) -> Bool {
        ...
        // - flameshot? https://github.com/BarutSRB/HyprSpace/issues/112
        // - Drata Agent https://github.com/BarutSRB/HyprSpace/issues/134
    ...
    func isWindowHeuristic(
        ...
        // https://github.com/BarutSRB/HyprSpace/issues/103
        ...
        // - Share window purple "pill" indicator https://github.com/BarutSRB/HyprSpace/issues/1101. Title is not empty
    ...
    private func isWindowHeuristicOld(axApp: AxUiElementMock, appBundleId: String?) -> Bool { // 0.18.3 hotfix
        ...
        if get(Ax.closeButtonAttr) == nil &&
            ...
            // Share window purple "pill" indicator has "Window" title https://github.com/BarutSRB/HyprSpace/issues/1101
