...
func parseAfterLoginCommand(_ raw: TOMLValueConvertible, _ backtrace: TomlBacktrace) -> ParsedToml<[any Command]> {
    ...
    let msg = "after-login-command is deprecated since HyprSpace 0.19.0. https://github.com/BarutSRB/HyprSpace/issues/1482"
...
func parseIndentForNestedContainersWithTheSameOrientation(
    ...
    let msg = "Deprecated. Please drop it from the config. See https://github.com/BarutSRB/HyprSpace/issues/96"
    return .failure(.semantic(backtrace, msg))
}
